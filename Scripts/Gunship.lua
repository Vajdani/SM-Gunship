...
local autocannonProjectile = uuid("083c9ce2-4210-40b6-a70a-febc24670cdd")
...
function Gunship:cl_updateCockpitUI(dt)
    ...
    wgui.engine1HealthText:setPosition(healthCenter - uiEngineRightOffset * 1.575 + uiEngineUpOffset)
    ...
    wgui.engine3HealthText:setPosition(healthCenter - uiEngineRightOffset * 1.575 - uiEngineUpOffset)
